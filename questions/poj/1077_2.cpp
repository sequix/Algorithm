// POJ No.1077 Eight (BFS+排列序数判重+string改为char[]) (2536K 563MS)
// 需要对某种简单数据类型进行大量操作，比如这里对字符串的判重，为了速度
// 少用STL
#include <cstdio>
#include <bitset>
#include <cstring>
...
char anspath[100];				// 所求路径的逆序
char orig[32];					// 初始状态 (新第0个排列)
